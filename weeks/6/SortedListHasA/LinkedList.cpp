...
ItemType LinkedList<ItemType>::getEntry(int position) const 
{
   ...
   {
      string message = "ERROR AUWHDOAUBHDWOUAWD getEntry() called with an empty list or "; 
      message  = message + "invalid position. The Position you input is: " 
      + std::to_string(position)
      + " and the item count is: " + std::to_string(itemCount);
